...
import Example from './feedback';
import Button1 from './button';
import Example1 from './checkbox';
export default function PopupGfg(){
return(
<div>
	
	<Popup  contentStyle={{width:"1000px",height:"600px"}} trigger={<button> Click to open popup </button>}
